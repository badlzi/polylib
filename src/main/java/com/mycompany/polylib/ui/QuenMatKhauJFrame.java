...
public class QuenMatKhauJFrame extends javax.swing.JFrame {
    ...
    public QuenMatKhauJFrame() {
        ...
        txt_XacNhan.setBackground(new java.awt.Color(0,0,0,1));
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(184, 25, -1, 60));

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Email:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 60, -1));

        jLabel3.setFont(new java.awt.Font("Sitka Text", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Mật khẩu mới:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 218, -1, 20));
        ...
        getContentPane().add(txt_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(176, 130, 340, 40));
        ...
        getContentPane().add(txt_MatKhauMoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(176, 210, 340, 40));

        txt_XacNhan.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txt_XacNhan.setForeground(new java.awt.Color(255, 255, 255));
        txt_XacNhan.setText("jPasswordField2");
        txt_XacNhan.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(255, 255, 255)));
        getContentPane().add(txt_XacNhan, new org.netbeans.lib.awtextra.AbsoluteConstraints(172, 290, 340, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 400, 210, 50));
