...
//        txt_MatKhauMoi.setEchoChar((char) 0);
    ...
    private void initComponents() {
        ...
        getContentPane().add(btn_XacNhan, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 380, 400, 50));
        ...
        getContentPane().add(btn_DangNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 310, 130, 30));
...
//        System.out.println(txt_MatKhauMoi.getText().length());
    ...
    private void btn_GuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_GuiActionPerformed
        kiemtraxacnha(txt_email.getText());
    ...
    public String kiemtraxacnha(String email) {
        NVL = NVD.selectAll();
        String emailtest = "";
        for (NhanVien s : NVL) {
            if (s.getEmail().equals(email)) {
                ...
                MsgBox.alert(this, "email bạn không tồn tại trong app");
                break;
            }
        }
        return null;
